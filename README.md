...
> 124 款游戏 + 大厅 + 自动化测试套件，全部用原生 HTML/CSS/JS 写成，双击即玩。

## ✨ 特性

- **124 款游戏**，覆盖经典类型：益智 / 棋牌 / 动作 / 射击 / 竞速 / 解谜 / 文字 / 多人竞技 / 社交推理 / 策略桌游 / 枪战
...
- **自动化测试**：CLI 静态检测（752 项）+ node 逻辑单测（3106 项），全套全绿
