...
> 生成时间：2026-08-07T09:39:26.136Z（由 `node metrics-report.js` 自动生成，勿手改）
...
**最大 5 款**：tetris.html（919 行）、carrot.html（890 行）、bubble.html（877 行）、rhythm.html（877 行）、runner.html（838 行）
