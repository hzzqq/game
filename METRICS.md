...
> 生成时间：2026-09-17T15:55:10.429Z（由 `node metrics-report.js` 自动生成，勿手改）
...
| 手写 diffbar（待收口 buildDiffBar） | 20 款 |
...
**最大 5 款**：bubble.html（936 行）、tetris.html（912 行）、carrot.html（890 行）、rhythm.html（882 行）、runner.html（839 行）
