...
> 生成时间：2026-07-29T05:00:52.862Z（由 `node metrics-report.js` 自动生成，勿手改）
...
**最大 5 款**：tetris.html（919 行）、carrot.html（890 行）、rhythm.html（883 行）、bubble.html（877 行）、runner.html（838 行）
