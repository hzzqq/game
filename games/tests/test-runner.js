...
const FILES = {
  ...
  'bullscow.html':     { name:'猜数字 1A2B BullsCow',          offline:true },
  'typing.html':       { name:'打字速度 Typing',              offline:true },
  'wordchain.html':    { name:'单词接龙 WordChain',           offline:true },
  'mini2048.html':     { name:'迷你 2048 3×3',                offline:true },
  'spacewipe.html':   { name:'太空清屏 SpaceWipe',          offline:true },
  'lazermaze.html':   { name:'激光迷宫 LazerMaze',          offline:true },
  'bullethell.html':  { name:'弹幕躲避 BulletHell',         offline:true },
  'lanesprint.html':  { name:'极简竞速 LaneSprint',         offline:true },
  'rhythmclick.html': { name:'双键节奏 RhythmClick',        offline:true },
  'ultimatettoe.html': { name:'终极井字棋 Ultimate TTT',      offline:true },
  'qubic.html':        { name:'立体四子棋 Qubic',             offline:true },
  'breakthrough.html': { name:'突破棋 Breakthrough',          offline:true },
  'ataxx.html':        { name:'传染棋 Ataxx',                 offline:true },
  'flowfree.html':    { name:'流水连线 Flow Free',          offline:true },
  'tangram.html':     { name:'七巧板拼板 Tangram',           offline:true },
